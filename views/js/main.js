...
function updatePositions() {
  ...
  var scrollTopPos = document.body.scrollTop / 1250;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin(scrollTopPos + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var elemPizza=document.getElementById("movingPizzas1");
  for (var i = 0; i < 50; i++) {
